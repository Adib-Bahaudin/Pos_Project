...
from src.utils.logger import get_logger, log_critical

class InitDatabase:
    def __init__(self):
        super().__init__()
        self.logger = get_logger("InitDatabase")
        ...
        try:
            ...
            log_critical(e, context="saat menginisialisasi tabel database dan master user", logger=self.logger)
            raise e
